...
begin
  ...
  x2 := (Image1.Width div 2) - Obr.Width div 2 + ((Image1.Width / Image1.Height) * nasobic);
  y2 := (Image1.Height div 2) - Obr.Height div 2 + ((Image1.Height / Image1.Width) * nasobic);
  x4 := (Image1.Width div 2) + Obr.Width div 2 - ((Image1.Width / Image1.Height) * nasobic);
  y4 := (Image1.Height div 2) + Obr.Height div 2 - ((Image1.Height / Image1.Width) * nasobic);
  x3 := Round(x2);
  y3 := Round(y2);
  x5 := Round(x4);
  y5 := Round(y4);
